 ...
 */
public class VideoQueueBrowserFragment extends Fragment implements VideoListAdapter.ItemClickListener,
        LoaderManager.LoaderCallbacks<List<MediaItem>> {

    private static final String TAG = "VideoQueueBrowser";
    ...
    public void itemClicked(View view, MediaItem item, int position) {
        // notify listener to play this video
        Log.d(TAG, "itemClicked() pass media item to VideoBrowserActivity");
        ((VideoBrowserActivity) getActivity()).onVideoItemClicked(item);
